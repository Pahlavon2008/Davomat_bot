...
from save_cav import save_to_csv, get_user_buttons, day_attendance

API_TOKEN = '7592490620:AAHhIqPCVqxYgNGy8Ygutrj1EMfG7SrlDdo'
...
async def start_bot(bot: Bot):
    await bot.send_message(7012692395,"Bot ishga tushdi !! ")

async def shutdown_bot(bot: Bot):
    await bot.send_message(7012692395,"Bot o'chdi !! ")
